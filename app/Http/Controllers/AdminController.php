...
class AdminController extends Controller
{
    public function index()
    {
        ...
        return view('admin.index', compact('orders', 'dashbordDatas','AmountM','OrderedAmountM','DeliveredAmountM','CanceledAmountM','TotalAmount','TotalOrderedAmount','TotalDeliveredAmount','TotalCanceledAmount'));
    }
    ...
    public function brand_update(Request $request)
    {
        ...
        if($request->hasFile('image')){
            if(File::exists(public_path('uploads/brnads').'/'.$brand->image))
            {
                File::delete(public_path('uploads/brnads').'/'.$brand->image);
            }
            $image = $request->file('image');
            $file_extension = $request->file('image')->extension();
            $file_name = Carbon::now()->timestamp . '.' . $file_extension;
    ...
    public function product_update(Request $request)
    {
        ...
        $product -> save();
        return redirect()->route('admin.products')->with ('status','Product has benn updated successfully! ');
    }
    ...
    public function search(Request $request)
    {
        ...
        $products = Product::where('name', 'LIKE', "%{$query}%")->take(8)->get();
