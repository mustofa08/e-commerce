                ...
                <div class="col-lg-10">
                    <div class="wg-box">
                        ...
                        <div class="table-responsive">
                            ...
                            @endif
                            <table class="table-bordered table table-striped table-transaction">
                                <thead>
                                    <tr>
                                        <th>Order No</th>
                                        <td>{{$order->id}}</td>
                    ...
                    <div class="wg-box mt-5 text-right">
                        <form action="{{route('user.order.cancel')}}" method="POST">
                            ...
                            <button type="button" class="btn btn-danger cancle-order">Cacncel Order</button>
                        </form>
                    </div>
                    @endif
                </div>
...
@push('scripts')
    <script>
        $(function(){
            $('.cancle-order').on('click',function(e){
                e.preventDefault();
